# smartmoney--ai-analysis

Personal budget tracker for a retiree to log expenses (manual or receipt-snapshot with AI extraction), visualize spend vs MYR 6,000 monthly budget across 10 categories, and get AI-driven savings recommendations.
